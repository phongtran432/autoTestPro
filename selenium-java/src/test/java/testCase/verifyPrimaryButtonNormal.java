...
public class verifyPrimaryButtonNormal {
   ...
   @Test(priority=0)
   public void verify_backgroundColorNormal(){
	   objInteractive = new interactivePosition(driver);
	   System.out.println("Background color: " + objInteractive.getBackgroundColorNormal());
   }
